    ...
    <script>
        ...
        $(function () {
                            ...
                            * */
                            ...
                            /*
                                注意：
                                    ...
                                    但是表单的jquery对象，没有为我们提供reset方法让我们重置表单

                                    使用原生的js我们提供给了reset方法
                                    所以要将jquery对象转换为原生的dom对象
            ...
            $("#searchBtn").click(function () {
                ...
                /*
                    点击查询按钮的时候，我们应该将搜索框中的信息保存,保存到隐藏域中
                 */
            ...
            /*
                在实际项目开发中，一定是先添加了之后，再做修改这种顺序
                所以，为了节省时间，修改一般都是copy添加操作
             */
        ...
        /*
            ...
            pageList方法：就是发出ajax请求到后台，从后台取得最新的市场活动信息列表的数据
                          通过响应回来的数据，局部刷新市场活动信息列表

            我们都在什么情况下，需要调用pageList方法
                (1)点击左侧菜单中的“市场活动”
                (2)添加，修改，删除后，需要刷新市场活动列表
                (3)点击查询按钮，需要刷新市场活动列表
                (4)点击分页组件的时候，需要调用pageList方法
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data.dataList, function (i, n) {
                        ...
                        html += '<td><a style="text-decoration: none; cursor: pointer;" onclick="location.href=\'workbench/activity/detail.do?id='+n.id+'\';">' + n.name + '</a></td>';
                        html += '<td>' + n.owner + '</td>';
        ...
        <div class="btn-toolbar" role="toolbar"
            ...
            <div class="btn-group" style="position: relative; top: 18%;">
                ...
                <button type="button" class="btn btn-default"
                        id="editBtn"><span class="glyphicon glyphicon-pencil"></span> 修改
                </button>
